...
;(async () => {
  try {
    ...
    const host =
      "mongodb+srv://m220student:m220password@mflix-ivklx.mongodb.net/test?retryWrites=true&w=majority"
    ...
    const cursor = await mflix
      ...
      .toArray()
    console.log("\x1b[32m", `Found ${cursor.length} documents to update`)
